...
def plot_histograms_and_clean_catalog(catalog_file, output_dir, cleaned_catalog_file):
...
if __name__ == "__main__":
    ...
    plot_histograms_and_clean_catalog(args.catalog_file, args.output_dir, args.cleaned_catalog_file)
