...
if __name__ == "__main__":
    data_catalog = 'catalogs/electrons_vary_distributions_vary_settings_filtered_total_charge_51_catalog_train_sdf.csv'
    statistics_file = 'catalogs/global_statistics_filtered_total_charge_51_train.txt'
