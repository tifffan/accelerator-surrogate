...
#SBATCH --output=logs/train_gtr_ae_%j.out
#SBATCH --error=logs/train_gtr_ae_%j.err

# =============================================================================
# SLURM Job Configuration for Graph Transformer AutoEncoder (gtr-ae)
# =============================================================================
...
POOL_RATIOS="0.6 0.4"          # For depth=3 (num_layers=6), pool_ratios=depth-1=2

# Additional hyperparameters for Transformer models
GTR_HEADS=8                    # Number of attention heads for Transformer layers
GTR_CONCAT=true                # Whether to concatenate attention heads
GTR_DROPOUT=0.3                # Dropout rate for Transformer layers
