...
GTR_HEADS=4                    # Number of attention heads for TransformerConv layers
GTR_CONCAT=true                # Whether to concatenate attention head outputs
GTR_DROPOUT=0.1                # Dropout rate for attention coefficients
