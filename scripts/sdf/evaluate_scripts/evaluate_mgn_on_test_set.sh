...
CHECKPOINT="/sdf/data/ad/ard/u/tiffan/results/mgn/graph_data_filtered_total_charge_51/predict_n6d/knn_k5_weighted_r63_nt4156_b32_lr0.0001_h256_ly6_pr1.00_ep3000_sch_lin_100_1000_1e-05/checkpoints/model-2999.pth"

# Specify the results folder
RESULTS_FOLDER="evaluation_results_test/mgn/graph_data_filtered_total_charge_51/predict_n6d/knn_k5_weighted_r63_nt4156_b32_lr0.0001_h256_ly6_pr1.00_ep3000_sch_lin_100_1000_1e-05/model-2999/"  # You can change this to your desired results folder

# Optional: Set the number of samples to evaluate
# SUBSAMPLE_SIZE=100  # Set to the number of samples you want to evaluate, or comment out if you want to use the full dataset
