...
#SBATCH --job-name=evaluate_gat
#SBATCH --output=logs/evaluate_gat_%j.out
#SBATCH --error=logs/evaluate_gat_%j.err
#SBATCH --ntasks=1
...
CHECKPOINT="/sdf/data/ad/ard/u/tiffan/results/gat/graph_data_filtered_total_charge_51/predict_n6d/knn_k5_weighted_r63_nt4156_b4_lr0.0001_h256_ly6_pr1.00_ep3000_sch_lin_400_4000_1e-05_heads4/checkpoints/model-2999.pth"

# Specify the results folder
RESULTS_FOLDER="evaluation_results/gat/graph_data_filtered_total_charge_51/predict_n6d/knn_k5_weighted_r63_nt4156_b4_lr0.0001_h256_ly6_pr1.00_ep3000_sch_lin_400_4000_1e-05_heads4/model-2999/"
