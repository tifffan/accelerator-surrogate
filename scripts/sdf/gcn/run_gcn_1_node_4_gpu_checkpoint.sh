...
#SBATCH --job-name=run_gcn_1_4
#SBATCH --output=logs/run_gcn_1_4_%j.out
#SBATCH --error=logs/run_gcn_1_4_%j.err
#SBATCH --ntasks=1
...
CHECKPOINT="/sdf/data/ad/ard/u/tiffan/results/gcn/graph_data_filtered_total_charge_51/predict_n6d/knn_k5_weighted_r63_nt4156_b4_lr0.0001_h256_ly6_pr1.00_ep3000_sch_lin_400_4000_1e-05/checkpoints/model-79.pth"
