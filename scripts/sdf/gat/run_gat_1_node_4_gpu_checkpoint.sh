...
#SBATCH --job-name=run_gat_1_4
#SBATCH --output=logs/run_gat_1_4_%j.out
#SBATCH --error=logs/run_gat_1_4_%j.err
#SBATCH --ntasks=1
...
# CHECKPOINT=None
CHECKPOINT="/sdf/data/ad/ard/u/tiffan/results/gat/graph_data_filtered_total_charge_51/predict_n6d/knn_k5_weighted_r63_nt4156_b4_lr0.0001_h256_ly6_pr1.00_ep3000_sch_lin_400_4000_1e-05_heads4/checkpoints/model-329.pth"
